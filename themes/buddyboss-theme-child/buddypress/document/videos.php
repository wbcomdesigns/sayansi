...
foreach( $video_files as $video_file ){
    echo '<tr>';
    echo '<td>' . $video_file->title .'</td>';
    echo '<td>' . date('Y-m-d', strtotime( $video_file->date_modified ) ) .'</td>';
    echo '<td>' . $video_file->status .'</td>';
    echo '</tr>';
