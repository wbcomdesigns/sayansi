...
?>
<div id="bp-profile-setting-about-content" class="tab-content settings-tab-content">
...
<div id="bp-profile-about-content" class="tabs bp-business-settings-content">
	...
	<?php
	if ( apply_filters( 'bp_business_profile_about_show_sidebar', true ) ) {		
		bp_business_profile_locate_template( 'single/business-right-sidebar.php', true ); 
	}
	?>	
