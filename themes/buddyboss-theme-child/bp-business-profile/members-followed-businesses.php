...
if ( $business_query->have_posts() ) :
	...
	<div class="bp-business-profile-header">
		<div class="bp-business-my-partner-label">
			<h3> <?php echo esc_html( 'My Partners');?></h3>
		</div>
		...
		<div class="bp-business-profile-list-grid-filter-wrapper">
			<div class="bp-business-profile-list-grid-filter">
				<a href="#" id="toggle-view-grid" class="btn-grid <?php echo $active_view === 'grid' ? 'active' : ''; ?> layout-view layout-list-view bp-tooltip" data-view="grid" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Grid View', 'bp-business-profile' ); ?>">
				...
				<a href="#" id="toggle-view-list" class="btn-list <?php echo $active_view === 'list' ? 'active' : ''; ?> layout-view layout-list-view bp-tooltip" data-view="list" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'List View', 'bp-business-profile' ); ?>">
